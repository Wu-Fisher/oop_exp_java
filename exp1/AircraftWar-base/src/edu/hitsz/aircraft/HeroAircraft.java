...
public class HeroAircraft extends AbstractAircraft {
    ...
    @Override
    public void setStrategy(AbstractShootStrategy shootStrategy) {
    ...
    public List<BaseBullet> shoot() {
        ...
        if (this.shootStrategy == null) {
            ...
            return res;
        } else if (this.shootStrategy != null) {
            return this.shootStrategy.shoot(getLocationX(), getLocationY(), getSpeedX(), getSpeedY(), shootSpeed,
